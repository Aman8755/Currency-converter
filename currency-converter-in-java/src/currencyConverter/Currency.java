	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 81.31);
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR", 84.428);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 97.66);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 85.65);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 11.48);
				break;
			case "Japanese Yen":
			...
			case "Indian Rupee":
				...
				this.exchangeValues.put("JPY", 1.71);
